...
//////////////////////////////////////////////
/////////////////////////////////////////////
+ (NSString *)getWebserviceUrl:(AWAREStudy *) awareStudy{
...
+ (NSString *)getInsertUrl:(NSString *)name awareStudy:(AWAREStudy *)study{
    //    - insert: insert new data to the table
    return [NSString stringWithFormat:@"%@/%@/insert", [AWAREUtils getWebserviceUrl:study], name];
}


+ (NSString *)getLatestDataUrl:(NSString *)name awareStudy:(AWAREStudy *)study{
    //    - latest: returns the latest timestamp on the server, for synching what’s new on the phone
    return [NSString stringWithFormat:@"%@/%@/latest", [AWAREUtils getWebserviceUrl:study], name];
}


+ (NSString *)getCreateTableUrl:(NSString *)name awareStudy:(AWAREStudy *)study{
    //    - create_table: creates a table if it doesn’t exist already
    return [NSString stringWithFormat:@"%@/%@/create_table", [AWAREUtils getWebserviceUrl:study], name];
}


+ (NSString *)getClearTableUrl:(NSString *)name awareStudy:(AWAREStudy *)study{
    //    - clear_table: remove a specific device ID data from the database table
    return [NSString stringWithFormat:@"%@/%@/clear_table", [AWAREUtils getWebserviceUrl:study], name];
}
