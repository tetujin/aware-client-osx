...
+ (NSString *) getInsertUrl:(NSString *)sensorName awareStudy:(AWAREStudy *) study;
+ (NSString *) getLatestDataUrl:(NSString *)sensorName awareStudy:(AWAREStudy *) study;
+ (NSString *) getCreateTableUrl:(NSString*) sensorName awareStudy:(AWAREStudy *) study;
+ (NSString *) getClearTableUrl:(NSString*) sensorName awareStudy:(AWAREStudy *) study;
